...
describe('renderer CSP', () => {
  it('生产态只允许官网群码清单，开发态在此基础上保留本地 HMR websocket', () => {
    expect(productionCsp).toContain("connect-src https://laixin.net.cn")
    expect(productionCsp).toContain("img-src 'self' data: https://laixin.net.cn")
    ...
    expect(developmentCsp).toContain('https://laixin.net.cn')
  })
})
